...
export class TokenValue {
  ...
  /**
   * Create a TokenValue from another decimal-supporting object: Decimal or TokenValue.
   *
   * @param value The amount
   * @returns a TokenValue
   */
  static from(value: Decimal | TokenValue): TokenValue {
  ...
  constructor(_blocker: typeof blocker, _bigNumber: BigNumber, decimals: number) {
    ...
    this.value = new Decimal(_bigNumber, decimals);
  ...
  private toDBN(num: TokenValue | BigNumber | number): Decimal {
