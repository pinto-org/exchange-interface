...
export class ChainResolver {
  ...
  static defaultChainId: MainnetChainId = ChainId.BASE_MAINNET;
   ...
   */
  static isL1Chain(_chainId: ChainId) {
  ...
  static isL2Chain(chainId: ChainId) {
    return ChainResolver.resolveToMainnetChainId(chainId) === ChainId.BASE_MAINNET;
  }
}
