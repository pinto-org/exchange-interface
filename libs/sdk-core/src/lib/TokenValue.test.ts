...
describe('TokenValues', function () {
  ...
  it('static constant values', () => {
    ...
    expect(TokenValue.MAX_UINT256.toBigNumber()._hex).toBe(
  ...
  it('add', () => {
    ...
    expect(TokenValue.fromBlockchain(BigNumber.from('3140000'), 6).add(BigNumber.from('100'))).toMatchTokenValue(
      6,
      '103.14'
    );
  });
  ...
  it('sub', () => {
    ...
    expect(TokenValue.fromHuman('100.5', 6).sub(BigNumber.from(1))).toMatchTokenValue(
      6,
      '99.5',
      BigNumber.from('99500000')
    );
    // effectively 100.5 - 50
    expect(TokenValue.fromHuman('100.5', 6).sub(TokenValue.fromHuman('50.5', 0))).toMatchTokenValue(
      6,
      '50.5',
      BigNumber.from('50500000')
    );
    // effectively 100.5 - 50.5
    expect(TokenValue.fromHuman('100.5', 6).sub(TokenValue.fromHuman('50.5', 6))).toMatchTokenValue(
      6,
      '50',
      BigNumber.from('50000000')
    );
    // TODO: is this right??!!
    expect(TokenValue.fromHuman('100.5', 6).sub(TokenValue.fromHuman('50.5', 7))).toMatchTokenValue(
      7,
      '50',
  ...
  it('mul', () => {
    ...
    expect(TokenValue.fromHuman('100.5', 0).mul(TokenValue.fromHuman('1.123456789', 9))).toMatchTokenValue(
      0,
      '112',
      BigNumber.from('112')
    );
  ...
  it('mod', () => {
    expect(TokenValue.fromHuman('100.5', 6).mod(TokenValue.fromHuman(2, 6))).toMatchTokenValue(
      6,
      '0.5',
      BigNumber.from('500000')
    );
    expect(TokenValue.fromHuman('100.5', 6).mod(2)).toMatchTokenValue(6, '0.5', BigNumber.from('500000'));
    expect(TokenValue.fromHuman('4', 10).mod(TokenValue.fromHuman(3, 6))).toMatchTokenValue(
      10,
      '1',
