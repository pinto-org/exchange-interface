  ...
  async run(_amountInStep: ethers.BigNumber, context: RunContext) {
    ...
    return {
      ...
      prepare: () => {
        ...
        return {
          target: UnwrapEth.sdk.contracts.diamond.address,
          callData: UnwrapEth.sdk.contracts.diamond.interface.encodeFunctionData('unwrapEth', [
      ...
      decode: (data: string) => UnwrapEth.sdk.contracts.diamond.interface.decodeFunctionData('unwrapEth', data),
      decodeResult: (result: string) =>
        UnwrapEth.sdk.contracts.diamond.interface.decodeFunctionResult('unwrapEth', result)
    };
  }
}
