  ...
  async run(_amountInStep: ethers.BigNumber, context: RunContext) {
    return {
      ...
      prepare: () => {
        ...
        return {
          target: TransferToken.sdk.contracts.diamond.address,
          callData: TransferToken.sdk.contracts.diamond.interface.encodeFunctionData('transferToken', [
            this._tokenIn, //
            this._recipient, //
      ...
      decode: (data: string) => TransferToken.sdk.contracts.diamond.interface.decodeFunctionData('transferToken', data),
      decodeResult: (result: string) =>
        TransferToken.sdk.contracts.diamond.interface.decodeFunctionResult('transferToken', result)
    };
  }
}
