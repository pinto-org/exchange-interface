  ...
  async run(_amountInStep: ethers.BigNumber, context: RunContext) {
    return {
      ...
      prepare: () => {
        ...
        return {
          target: WrapEth.sdk.contracts.diamond.address,
          callData: WrapEth.sdk.contracts.diamond.interface.encodeFunctionData('wrapEth', [
      ...
      decode: (data: string) => WrapEth.sdk.contracts.diamond.interface.decodeFunctionData('wrapEth', data),
      decodeResult: (result: string) => WrapEth.sdk.contracts.diamond.interface.decodeFunctionResult('wrapEth', result)
    };
  }
}
