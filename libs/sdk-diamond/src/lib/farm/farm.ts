...
import { Diamond, Depot } from 'src/constants/generated';
import { TokenValue } from '@exchange/sdk-core';
import { CallOverrides, ethers } from 'ethers';
import { AdvancedPipeWorkflow } from 'src/lib/depot/pipe';
import { AdvancedFarmCallStruct } from 'src/constants/generated/Diamond';
...
> {
  ...
  private contract: Diamond | Depot;

  constructor(
    sdk: DiamondSDK,
    public name: string = 'Farm',
    using: 'diamond' | 'depot' = 'diamond'
  ) {
    super(sdk, name);
    this.contract = Workflow.sdk.contracts[using]; // use diamond or depot
  }
...
> {
  ...
  private contract: Diamond;

  constructor(
    protected sdk: DiamondSDK,
    public name: string = 'AdvancedFarm'
  ) {
    super(sdk, name);
    this.contract = Workflow.sdk.contracts.diamond; // ?
  }
