...
export abstract class ERC20SwapNode extends SwapNode implements IERC20SwapNode {
  ...
  constructor(sdk: DiamondSDK, sellToken: ERC20Token, buyToken: ERC20Token) {
    super(sdk);
...
export class WellSwapNode extends ERC20SwapNode {
  ...
  constructor(sdk: DiamondSDK, well: BasinWell, sellToken: ERC20Token, buyToken: ERC20Token) {
...
export class WellSyncSwapNode extends ERC20SwapNode {
  ...
  constructor(sdk: DiamondSDK, well: BasinWell, sellToken: ERC20Token, buyToken: ERC20Token = well.lpToken) {
    super(sdk, sellToken, buyToken);
    this.well = well;
    this.allowanceTarget = this.well.address;
  }
