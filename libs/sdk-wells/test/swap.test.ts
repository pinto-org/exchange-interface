...
describe('Swap', () => {
  describe('PINTO WETH well (two token well)', () => {
    ...
    beforeAll(async () => {
      testPINTOWethWell = await createWell([wellsSdk.tokens.PINTO, wellsSdk.tokens.WETH], account);
    });
  ...
  //   beforeAll(async () => {
  //     testPINTOWethUsdcWell = await createWell([wellsSdk.tokens.PINTO, wellsSdk.tokens.WETH, wellsSdk.tokens.USDC], account);
  ...
  //   describe.each([
  //     [wellsSdk.tokens.PINTO, wellsSdk.tokens.DAI],
  //     [wellsSdk.tokens.DAI, wellsSdk.tokens.PINTO]
  //   ])("invalid swaps", (tokenIn, tokenOut) => {
  //     it(`${tokenIn.symbol} -> ${tokenOut.symbol}`, async () => {
