...
export default abstract class Pool {
   ...
   */
  static tokenForLP = (amount: TokenValue, reserve: TokenValue, totalLP: TokenValue) =>
    amount.mul(reserve).div(totalLP);
   ...
   */
  static lpForToken = (amount: TokenValue, reserve: TokenValue, totalLP: TokenValue) =>
    amount.mul(totalLP).div(reserve);
