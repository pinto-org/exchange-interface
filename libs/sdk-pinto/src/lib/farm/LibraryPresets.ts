...
import { BeanstalkSDK } from 'src/lib/PintoSDK';
  ...
  constructor(sdk: BeanstalkSDK) {
    ...
    this.stable2beanWstETH = (
      ...
      if (!stables.some((t) => t.equals(fromToken))) {
        throw new Error(`[stable2wstETH] expected tokenIn to be DAI, USDC, USDT, but got ${fromToken.symbol}`);
      }
    ...
    this.bean2Stable = (toToken: ERC20Token, account: string, fromMode?: FarmFromMode, toMode?: FarmToMode) => {
      return [
        this.wellSwapUniV3(
          sdk.pools.BEAN_WSTETH_WELL,
          account,
    ...
    this.stable2Bean = (fromToken: ERC20Token, account: string, fromMode?: FarmFromMode, toMode?: FarmToMode) => {
      return [
        this.uniswapV3Swap(fromToken, sdk.tokens.WETH, account, 500, fromMode, FarmToMode.INTERNAL),
        this.uniV3WellSwap(
          sdk.pools.BEAN_WSTETH_WELL,
    ...
    this.stable2wstETH = (fromToken: ERC20Token, account: string, fromMode?: FarmFromMode, toMode?: FarmToMode) => {
      ...
      return [
        this.uniswapV3Swap(fromToken, sdk.tokens.WETH, account, 500, fromMode, FarmToMode.INTERNAL),
        this.uniswapV3Swap(sdk.tokens.WETH, sdk.tokens.WSTETH, account, 100, FarmFromMode.INTERNAL_TOLERANT, toMode)
      ];
    };
