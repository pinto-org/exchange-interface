...
export class WellFunction {
  ...
  constructor(
    public readonly sdk: ExchangeSDK,
  ...
  static async BuildConstantProduct(sdk: ExchangeSDK): Promise<WellFunction> {
  ...
  static async BuildConstantProduct2(sdk: ExchangeSDK): Promise<WellFunction> {
