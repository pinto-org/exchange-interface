...
export class Well {
  ...
  constructor(sdk: ExchangeSDK, address: string) {
    if (!address) {
   ...
   */
  static createWithParams(sdk: ExchangeSDK, params: CreateWellStaticParams) {
  ...
  static DeployContract(sdk: ExchangeSDK): Promise<WellContract> {
    if (!sdk.signer) {
