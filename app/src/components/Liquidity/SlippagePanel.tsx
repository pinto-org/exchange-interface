        ...
        <DesktopModal>
          ...
          <ModalContainer data-trace='true' onMouseDown={dontStealFocus}>
            ...
            <ModalContent>
              ...
              Slippage tolerance is the % change in token price caused by external factors between transaction
              submission and execution that you are willing to tolerate.
              <SlippageTextBottom>
      ...
      <MobileDrawer>
        <BottomDrawer showDrawer={modalOpen} headerText={'Adjust Slippage'} toggleDrawer={setModalOpen}>
          <ModalContent>
            ...
            Slippage tolerance is the % change in token price caused by external factors between transaction submission
            and execution that you are willing to tolerate.
            <SlippageTextBottom>
              Your transaction will revert if the price changes by more than the percentage specified.
            </SlippageTextBottom>
          </ModalContent>
