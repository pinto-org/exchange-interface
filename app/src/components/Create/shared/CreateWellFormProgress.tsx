...
type ViableProps = Omit<FunctionTokenPumpFormValues, 'wellFunctionData' | 'pumpData'> & WellDetailsFormValues;
  ...
  return (
    <ProgressContainer>
      ...
      <Text $color='text.secondary' $variant='xs'>
        Visit the <TextLink to='/build'>component library</TextLink> to learn more about the different Well components.
      </Text>
    </ProgressContainer>
  );
};
