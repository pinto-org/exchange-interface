...
export const makeCssStyle = <T>(props: ThemedStyledProps<T, any>, propKey: keyof typeof CSS_PROP_MAP): string => {
...
export type CommonCssProps = DimensionStyleProps & BoxSizingProps & DisplayStyleProps & BoxModelProps;
